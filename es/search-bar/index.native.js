        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(TextInput, _extends({ clearButtonMode: 'always', underlineColorAndroid: 'transparent', editable: !disabled }, restProps, { style: [styles.input, style], ref: function ref(el) {
                            return _this2.inputRef = el;
                        }, value: value, onChangeText: this.onChangeText, onSubmitEditing: this.onSubmit, onFocus: this.onFocus, onBlur: this.onBlur }))
                ),
