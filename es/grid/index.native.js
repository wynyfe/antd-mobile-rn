                ...
                var _loop = function _loop(j) {
                    ...
                    if (dataIndex < dataLength) {
                        ...
                        rowArr.push(React.createElement(
                            Flex.Item,
                            { key: j, style: [styles.grayBorderBox, flexItemStyle, { borderLeftWidth: hasLine && j === 0 ? StyleSheet.hairlineWidth : 0 }, customItemStyle], onPress: function onPress() {
            ...
            if (isCarousel && pageCount > 1) {
                for (var pageIndex = 0; pageIndex < pageCount; pageIndex++) {
                    ...
                    pagesArr.push(React.createElement(
                        View,
                        { key: pageIndex, style: [styles.grayBorderBox, { borderTopWidth: hasLine && pageIndex !== 0 ? StyleSheet.hairlineWidth : 0 }] },
                        pageRows
                    ));
                }
            }
