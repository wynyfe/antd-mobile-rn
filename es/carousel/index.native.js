    ...
    function Carousel(props) {
        ...
        _this.loopJump = function () {
            ...
            if (loopJump && Platform.OS === 'android') {
                ...
                setTimeout(function () {
                    _this.scrollviewRef.scrollTo({ x: x, y: y, animated: false });
                }, 10);
            }
        };
        ...
        _this.paging = function (offsetY) {
            ...
            if (Platform.OS === 'android' && vertical) {
                ...
                _this.scrollviewRef.scrollTo({ x: 0, y: (_selectedIndex + (infinite ? 1 : 0)) * height });
        ...
        _this.scrollNextPage = function () {
            ...
            if (vertical) {
                _this.scrollviewRef.scrollTo({ x: 0, y: diff * height });
            } else {
                _this.scrollviewRef.scrollTo({ x: diff * width, y: 0 });
            }
            _this.setState({
                isScrolling: true,
                autoplayEnd: false
            ...
            _this.setState({
                ...
                if (Platform.OS === 'android') {
                    ...
                    InteractionManager.runAfterInteractions(function () {
                        return _this.scrollviewRef.scrollTo({ x: offsetX, y: offsetY, animated: false });
                    });
                }
            });
        };
